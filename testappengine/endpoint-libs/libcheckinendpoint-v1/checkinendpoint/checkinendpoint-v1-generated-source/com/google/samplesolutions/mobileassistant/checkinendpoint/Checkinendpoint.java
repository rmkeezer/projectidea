 ...
 * on 2014-08-01 at 04:48:42 UTC 
 * Modify at your own risk.
 */

package com.google.samplesolutions.mobileassistant.checkinendpoint;
...
public class Checkinendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetCheckIn extends CheckinendpointRequest<com.google.samplesolutions.mobileassistant.checkinendpoint.model.CheckIn> {
    ...
    protected GetCheckIn(java.lang.Long id) {
      super(Checkinendpoint.this, "GET", REST_PATH, null, com.google.samplesolutions.mobileassistant.checkinendpoint.model.CheckIn.class);
   ...
   * operation.
   *
   * @param content the {@link com.google.samplesolutions.mobileassistant.checkinendpoint.model.CheckIn}
   * @return the request
   */
  public InsertCheckIn insertCheckIn(com.google.samplesolutions.mobileassistant.checkinendpoint.model.CheckIn content) throws java.io.IOException {
    InsertCheckIn result = new InsertCheckIn(content);
    initialize(result);
    return result;
  }

  public class InsertCheckIn extends CheckinendpointRequest<com.google.samplesolutions.mobileassistant.checkinendpoint.model.CheckIn> {
     ...
     * @since 1.13
     */
    protected InsertCheckIn(com.google.samplesolutions.mobileassistant.checkinendpoint.model.CheckIn content) {
      super(Checkinendpoint.this, "POST", REST_PATH, content, com.google.samplesolutions.mobileassistant.checkinendpoint.model.CheckIn.class);
    }
  ...
  public class ListCheckIn extends CheckinendpointRequest<com.google.samplesolutions.mobileassistant.checkinendpoint.model.CollectionResponseCheckIn> {
    ...
    protected ListCheckIn() {
      super(Checkinendpoint.this, "GET", REST_PATH, null, com.google.samplesolutions.mobileassistant.checkinendpoint.model.CollectionResponseCheckIn.class);
    }
  ...
  public class RemoveCheckIn extends CheckinendpointRequest<com.google.samplesolutions.mobileassistant.checkinendpoint.model.CheckIn> {
    ...
    protected RemoveCheckIn(java.lang.Long id) {
      super(Checkinendpoint.this, "DELETE", REST_PATH, null, com.google.samplesolutions.mobileassistant.checkinendpoint.model.CheckIn.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
   ...
   * @return the request
   */
  public UpdateCheckIn updateCheckIn(com.google.samplesolutions.mobileassistant.checkinendpoint.model.CheckIn content) throws java.io.IOException {
    UpdateCheckIn result = new UpdateCheckIn(content);
    initialize(result);
    return result;
  }

  public class UpdateCheckIn extends CheckinendpointRequest<com.google.samplesolutions.mobileassistant.checkinendpoint.model.CheckIn> {
     ...
     * @since 1.13
     */
    protected UpdateCheckIn(com.google.samplesolutions.mobileassistant.checkinendpoint.model.CheckIn content) {
      super(Checkinendpoint.this, "PUT", REST_PATH, content, com.google.samplesolutions.mobileassistant.checkinendpoint.model.CheckIn.class);
    }
